...
<head>
    ...
    <title>AFEAM :: Área do Administrador</title>
        ...
        <div class="sidebar-scroll">
            <nav>
                <ul class="nav">
                    ...
                    <li><a ui-sref-active="active" ui-sref="administradores" href="#!/administradores"><i class="lnr lnr-lock"></i> <span>Administradores e Atendentes</span></a></li>
                </ul>
            </nav>
        </div>
    </div>
